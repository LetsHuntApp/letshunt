          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              <select
                ...
                className={`flex-1 p-2 text-xs font-bold rounded-xl border max-h-40 overflow-y-auto ${selectBg}`}
              >
              ...
              <button
                ...
                disabled={gpsLoading}
                className={`px-2 py-2 rounded-xl text-xs font-bold border transition-all flex items-center gap-1 flex-shrink-0 ${
                  isDark
